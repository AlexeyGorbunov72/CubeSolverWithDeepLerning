...
void keyboard(unsigned char key, int, int)
{
    ...
    else if (key == 'r')
    {
        ...
        Cube answer = solver.solveTheCube(machine, model);
...
void initCube(int argc, char** argv, Model &model_)
{
    model = model_;
...
void initCube(int argc, char** argv, unsigned int* color_position, Model &model_)
{
    model = model_;
